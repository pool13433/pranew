	...
	<form class="ui form" id="formUpload" name="formUpload" method="post" action="<?= Yii::app()->createUrl('site/upload') ?>" enctype="multipart/form-data">
		<div class="three fields">
			<div class="field">
				...
				<input type="hidden" name="id" id="id"  value="<?= $sacredObject->obj_id ?>"/>
		...
		<div class="field">
			...
			<div class="box-browse-upload">
				...
				?>
				<input type="file" id="fileMain" name="fileMain" <?= $require ?> style="display: none;" accept=".jpg,.png,.jpeg,.gif"/>
...
<script type="text/javascript">
    ...
    function validateFormUpload() {
        $('.dropdown').dropdown();
		var uploadId = '<?=$sacredObject->obj_id?>';
		var fileRules = [];
		if(uploadId == ''){
			fileRules = [
            ...
            onSuccess: function (event, fields) {
                ...
                if (myDropzone.getQueuedFiles().length > 0) {
                    ...
                    $.ajax({
                        ...
                        processData: false,
						beforeSend : function(){
							$('#submit-all').addClass('loading')
							.text('กำลังอัพโหลดพระ กรุณารอสักครู่...').attr('disabled',true);
						},
