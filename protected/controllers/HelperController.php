...
class HelperController extends Controller {
    ...
    public function actionCollectionCriteria() {
        ...
        $collectionUser = $criteriaFilter->collectionUser;
        ...
        if (!empty($_POST)) {
            ...
            if (!empty($_POST['checked']) && is_numeric($_POST['value'])) {
            ...
            if (empty($_POST['freeSearch'])) {
                $collectionForm = $criteriaFilter->collectionForm;
            } else {
                $collectionForm['freeSearch'] = $_POST['freeSearch'];
            }
            
             if (empty($_POST['user'])) {
                $collectionUser = $criteriaFilter->collectionUser;
            } else {
                $collectionUser = $_POST['user'];
            }
            $criteria['form'] = $collectionForm;
            $criteria['types'] = $collectionType;
            $criteria['region'] = $collectionRegion;
            $criteria['user'] = $collectionUser;
